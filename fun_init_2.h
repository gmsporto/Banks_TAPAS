	...
	CYCLES(cur, cur1, "FIRMS")                                                 				
		{
			...
			//v[201]=v[200]/(v[152]/v[57]);				// ** Removed
			//WRITES(cur1, "firm_bank", ROUND(v[201], "UP"));	// ** Removed
			//WRITES(cur1, "firm_bank", uniform_int(1,v[57])); 	// ** Removed
			v[201]=VS(cur, "sector_id");
			WRITES(cur1, "firm_bank", v[201]);		// ** Included			
...
v[226]+=(v[193]-v[194]);											//total demand loans
	...
	CYCLES(financial, cur1, "BANKS")                                                 				
		...
		// WRITELLS(cur1, "Bank_Desired_Short_Term_Spread", v[54], 0, 1);				// ** Removed
		// WRITELLS(cur1, "Bank_Desired_Long_Term_Spread", v[54], 0, 1);				// ** Removed
		WRITELLS(cur1, "Bank_Interest_Rate_Short_Term", v[102]+v[54], 0, 1);				// ** Edited -> Equal long & short interest rates
		WRITELLS(cur1, "Bank_Interest_Rate_Long_Term", v[102]+v[54], 0, 1);				// ** Edited -> Equal long & short interest rates
		WRITELLS(cur1, "Bank_Accumulated_Profits", v[222], 0, 1);
		WRITELLS(cur1, "Bank_Stock_Deposits", v[224]/v[57], 0, 1);					// ** Included
//		WRITELLS(cur1, "Bank_Stock_Reserves", v[222]+(v[224]/v[57])-(v[214]/v[57]), 0, 1);			// ** Included (then excluded)
