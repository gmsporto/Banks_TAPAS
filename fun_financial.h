...
RESULT(SUM("Bank_Loans_Effective"))			// ** Edited

EQUATION("Financial_Sector_Flow_Loans") 		// ** Edited
RESULT(SUM("Bank_Flow_Loans"))

EQUATION("Financial_Sector_Flow_Deposits")		// ** Edited
RESULT(SUM("Bank_Flow_Deposits"))

EQUATION("Financial_Sector_RWAcpad")			// ** Included
RESULT(SUM("Bank_RWAcpad"))

	// ANALYSIS

EQUATION("Financial_Sector_Leverage")
// Total Stock of Loans over ** ACCUMULATED PROFITS ** 

	v[0]=V("Financial_Sector_Total_Stock_Loans");
	v[1]=V("Financial_Sector_Accumulated_Profits");
	v[2]= v[1]!=0? v[0]/v[1] : 0;
RESULT(v[2])


EQUATION("Financial_Sector_Effective_Capital_Ratio")
//Accumulated profits over ** RWAcpad **

	v[0]=V("Financial_Sector_Accumulated_Profits");
	v[1]=V("Financial_Sector_RWAcpad");
	v[2]= v[1]!=0? v[0]/v[1] : 0;
RESULT(v[2])
