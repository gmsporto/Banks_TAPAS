...
V("Firm_Debt_Servicing");			// Included
V("Firm_Probability_Default");			// Included
V("Firm_Interest_Rate");			// Included
V("Class_Debt_Servicing");			// Included
V("Class_Probability_Default");			// Included
V("Class_Interest_Rate");			// Included
...
V("Class_Loan_Expected_Payback");		// Included
V("Bank_Supply_Capital_Classes"); 		// Included
V("Bank_Loans_Effective_Classes");		// Included
V("Class_Stock_Loans");				// Edited
V("Class_Effective_Loans");			// Edited
...
V("Firm_Loan_Expected_Payback");		// Included
V("Bank_Supply_Capital_Firms");			// Included
V("Bank_Loans_Effective_Firms"); 		// Included
V("Bank_Loans_Effective");			// Included
V("Bank_Demand_Met");
...
V("Bank_RWAcpad");				// Included
//V("Bank_Supply_Reserves");			// Included (then excluded)
